  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Access Levels</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Different user roles have access to different features and capabilities on our platform.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-green-500">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Public Access</h3>
                <p className="text-gray-600">Anyone can view</p>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-blue-500">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Donor Access</h3>
                <p className="text-gray-600">Registered donors can</p>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center text-gray-700">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-purple-500">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Administrators can</p>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center text-gray-700">
          ...
          {user && (
            <div className="mt-12 text-center">
              <div className="inline-flex items-center bg-white px-6 py-3 rounded-full shadow-lg">
                <span className="text-gray-700 mr-2">You are currently logged in as:</span>
